...
export const metadata = {
  title: "Privacy Policy | PCE",
  description: "Privacy policy and data protection information for Precision Consulting Engineering.",
};
...
export default async function PrivacyPolicyPage() {
  ...
  // We'll search for 'Privacy Policy' or similar
  const { data: pageData, error } = await supabase
    .from("pages")
    .select("*")
    .or("title.eq.Privacy Policy,title.eq.Policy & Privacy,title.eq.privacy policy")
    .single();
